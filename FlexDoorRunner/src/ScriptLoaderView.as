package {
    ...
    {
        [Embed("../assets/stopButton.swf", symbol="StopButtonDown")]     private const _stopButtonDownSWF:Class;
        [Embed("../assets/stopButton.swf", symbol="StopButtonOver")]     private const _stopButtonOverSWF:Class;
        [Embed("../assets/stopButton.swf", symbol="StopButtonNormal")]   private const _stopButtonNormalSWF:Class;
        [Embed("../assets/stopButton.swf", symbol="StopButtonDisabled")] private const _stopButtonDisabledSWF:Class;

        [Embed("../assets/playButton.swf", symbol="PlayButtonDown")]     private const _playButtonDownSWF:Class;
        [Embed("../assets/playButton.swf", symbol="PlayButtonOver")]     private const _playButtonOverSWF:Class;
        [Embed("../assets/playButton.swf", symbol="PlayButtonNormal")]   private const _playButtonNormalSWF:Class;
        [Embed("../assets/playButton.swf", symbol="PlayButtonDisabled")] private const _playButtonDisabledSWF:Class;

        [Embed("../assets/pauseButton.swf", symbol="PauseButtonDown")]     private const _pauseButtonDownSWF:Class;
        [Embed("../assets/pauseButton.swf", symbol="PauseButtonOver")]     private const _pauseButtonOverSWF:Class;
        [Embed("../assets/pauseButton.swf", symbol="PauseButtonNormal")]   private const _pauseButtonNormalSWF:Class;
        [Embed("../assets/pauseButton.swf", symbol="PauseButtonDisabled")] private const _pauseButtonDisabledSWF:Class;
        ...
        public function init(runner:FlexDoorRunner){
            ...
            play_pause_btn.setStyle("upIcon", _playButtonNormalSWF);
            play_pause_btn.setStyle("downIcon", _playButtonDownSWF);
            play_pause_btn.setStyle("overIcon", _playButtonOverSWF);
            play_pause_btn.setStyle("disabledIcon", _playButtonDisabledSWF);

            play_pause_btn.setStyle("selectedUpIcon", _pauseButtonNormalSWF);
            play_pause_btn.setStyle("selectedDownIcon", _pauseButtonDownSWF);
            play_pause_btn.setStyle("selectedOverIcon", _pauseButtonOverSWF);
            play_pause_btn.setStyle("selectedDisabledIcon", _pauseButtonDisabledSWF);

            stop_btn.setStyle("upIcon", _stopButtonNormalSWF);
            stop_btn.setStyle("downIcon", _stopButtonDownSWF);
            stop_btn.setStyle("overIcon", _stopButtonOverSWF);
            stop_btn.setStyle("disabledIcon", _stopButtonDisabledSWF);
